...
@objc(VFCardFormExpiryDateTextField) public class CardFormExpiryDateTextField: BaseTextField {
    ...
    public private(set) var selectedMonth: Int? = nil {
        didSet {
            ...
            expirationMonthAccessibilityElement.accessibilityValue = self.selectedMonth.map {
                CardFormExpiryDateTextField.spellingOutDateFormatter.monthSymbols[$0 - 1]
            }
        }
    }
    ...
    @objc public private(set) var expirationMonthAccessibilityElement: CardFormExpiryDateTextField.InfoAccessibilityElement!
    @objc public private(set) var expirationYearAccessibilityElement: CardFormExpiryDateTextField.InfoAccessibilityElement!
    ...
    private func initializeInstance() {
        ...
        expirationMonthAccessibilityElement = CardFormExpiryDateTextField.InfoAccessibilityElement(expiryDateTextField: self, component: .month)
        expirationMonthAccessibilityElement.accessibilityLabel = "Expiration month"
        
        expirationYearAccessibilityElement = CardFormExpiryDateTextField.InfoAccessibilityElement(expiryDateTextField: self, component: .year)
...
//        validator = try? NSRegularExpression(pattern: "^([0-1]?\\d)/(\\d{1,2})$", options: [])
    ...
    public override func paste(_ sender: Any?) {
        ...
        } else if let match = CardFormExpiryDateTextField.monthStringRegularExpression
...
extension CardFormExpiryDateTextField {
    ...
    public class InfoAccessibilityElement: UIAccessibilityElement {
        ...
        unowned let expiryDateTextField: CardFormExpiryDateTextField
        
        init(expiryDateTextField textField: CardFormExpiryDateTextField, component: Component) {
